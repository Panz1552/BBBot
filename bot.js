...
❖-id ~ معلومات عنك
❖-bans ~ عدد الاشخاص المبندة ❖-avatar ~ صورتك او صورة الي تمنشنو
...
❖-schannel ~ اضهار الشات المخفية❖-clr <numbr> ~ مسح الشات بعدد
❖-clear ~ مسح الشات
...
❖-ct <name> ~ انشاء شات❖-cv <name> ~ انشاء رووم فويس
...
client.on('guildCreate', guild => {
     ...
     .setURL('https://discordapp.com/api/oauth2/authorize?client_id=490917423508357131&permissions=0&scope=bot')
  .setDescription(`**
  New Server Add BBBot Bot ✅
اسم السيرفر: ${guild.name}
صاحب السيرفر: ${guild.owner}**`);
client.channels.get("490858161419452416").sendEmbed(embed)
});
...
if (message.content.startsWith('>bcall')){
 if (message.author.id !== '424639806522523649') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
 if(!message.author.id === '424639806522523649') return;
